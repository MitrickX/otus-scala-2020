...
sealed trait SetStorageValueResponse
object SetStorageValueResponse {
  case object NotAllowed extends SetStorageValueResponse
  case object Success    extends SetStorageValueResponse
}
